  ...
  <div class="footer-right">
    ...
    if (isset($_SESSION['admin'])) {
      ...
      if (isset($isOnMessagePage) && $isOnMessagePage === true) {
        echo '<a href="../pages/contact.php"><img src="../image/icon-close-messagerie.webp" alt="quitter la messagerie"></a>';
      } else {
        echo '<a href="../admin/message.php"><img src="../image/icon-messagerie.webp" alt="accéder à la messagerie"></a>';
      };
      echo '</div>';
    }
    ?>
