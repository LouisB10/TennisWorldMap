  ...
  <div class="footer-status">
    ...
    <?php
     if(isset($_SESSION['admin'])) {
      echo '<img class="status-icon" src="../image/admin-connect" alt="Admin Connecté">';
    } 
      else {echo '<a href="../admin/deconnect.php"><img class="status-icon" src="../image/admin-deconnect" alt="Admin déconnecté"></a>';
      }
    ?>
  </div>
  <?php
