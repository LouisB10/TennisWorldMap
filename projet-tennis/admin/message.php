      ...
      <div class="messagerie-boites">
          <div class="boites-vertdiv">
            ...
            <div class="boite-choix"> 
              ...
              <img class="icon-messagerie" src="../image/icon-msgsup.png" alt="">
            </div>
          </div>
      </div>
      
      <div class="div-message-action">
        ...
        <div class="messagerie-action">

          <div class="action-div archive-repondre">
              <div class="action-topdiv">
                <p>Archive</p>
              </div>
              <div class="action-botdiv">
                <img src="../image/icon-archive" alt="">
              </div>
          </div>
          <div class="action-div archive-repondre">
              <div class="action-topdiv">
              ...
              <div class="action-botdiv">
                <img src="../image/icon-repondre" alt="">
              </div>
            </div>
          <div class="action-div">
              ...
              <div class="action-botdiv">
                <img src="../image/icon-supprimer" alt="">
              </div>
          </div>
