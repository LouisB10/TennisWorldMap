...
<?php 
    ...
    if(isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['message'])){
        ...
        $status_message = 1; /**message recu = 1, message archivé = 2 , message supprimé = 3 */
        $insert = "INSERT INTO messages(nom, prenom, email, message, date_envoi, status_message) VALUES (:nom, :prenom, :email, :message, :date_envoi, :status_message)";
        ...
        $req->bindParam(':status_message', $status_message  );
