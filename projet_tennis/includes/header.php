<header>
  ...
  <div class="nav-links-left"> 
    <ul>
      <li>
        <a href="../pages/index.php" class="nav-link" id="page-actuelle">Carte</a>
      </li>
      <li>
        <a href="../pages/classement.php" class="nav-link">Classement <br>ATP</a>
      </li>
    </ul>
  </div>
  <div class="menu-logo">
  ...
  <div class="nav-links-right">
    <ul>
      <li>
        <a href="../pages/calendrier.php" class="nav-link">Calendrier<br>des tournois</a>
      </li>
      <li>
